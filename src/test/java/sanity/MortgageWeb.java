...
public class MortgageWeb extends CommonOps {
    ...
    @Test(description = "Test 05 - Verify Loan Breakdown Graph")
    @Description("This test verify the loan breakdown graph using sikuli tool")
    public void test05_verifyLoanBreakdownGraph() {
        WebFlows.mortgageRepayment("500000","100000","3.1","25","2021",
                "1500","0.5","1000","0");
        WebFlows.loanBreakdownGraph();
        Verifications.visualElement("LoanBreakdown");
    }
}
